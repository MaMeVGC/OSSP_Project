...
## Live# OSSP_Project_Abraham_Abunu
...
- **System Call: `getpid()`**:  
  [View System Call](https://ababu1212.github.io/OSSP_Project_Abraham_Abunu/System_call.html) Website  
Experience a live version of the documentation and demo:  
**[Elive OS Installation & System Call](https://ababu1212.github.io/OSSP_Project_Abraham_Abunu/)**
...
5. Install the GCC compiler if it's not already installed
6. Compile the C program using GCC
7. Run the compiled execu# OSSP_Project_Abraham_Abunu
...
- **System Call: `getpid()`**:  
  [View System Call](https://ababu1212.github.io/OSSP_Project_Abraham_Abunu/System_call.html)table
8. Observe the output showing the process ID (PID)
9.  
